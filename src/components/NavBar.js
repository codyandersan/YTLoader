...
const NavBar = (props) => {
    return (
        <div className="mb-5 navbar bg-primary text-primary-content">
            ...
            <div className="navbar-end ">
                <a href='#' className="btn btn-ghost normal-case text-xl">YTLoader</a>

                <label className="swap swap-rotate">

                    {/* this hidden checkbox controls the state */}
                    <input type="checkbox" onChange={props.toggleTheme}/>
                    {/* checked false: it is night mode */}
                    {/* checked true: it is dark mode */}
                    {/* moon icon */}
